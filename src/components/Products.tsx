...
const Products: React.FC = () => {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      price: 'A consultar',
      description: 'El **fleje PET de 12 mm** es una alternativa resistente y ecológica al fleje de acero, ideal para el **embalaje de cargas medianas y pesadas**. Fabricado en **(PET)**, este fleje ofrece **alta resistencia a la tracción**, gran estabilidad dimensional y excelente desempeño frente a condiciones climáticas adversas. Gracias a su elasticidad controlada, mantiene la tensión sobre la carga durante más tiempo sin deformarse ni romperse, lo que lo hace ideal para asegurar pallets, cajas y materiales industriales de forma segura y eficiente.',
      image: flejePet,
      category: 'flejes',
      subcategory: 'PET',
      inStock: true,
